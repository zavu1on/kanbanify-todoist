...
describe("useCompleteTaskMutation", () => {
  ...
  it("removes the task from a project page's cache even when completed from a different screen", async () => {
    ...
    // already exists — even though the completion happens from Calendar.
    ...
    const { result } = renderHook(
      () => useCompleteTaskMutation(calendarQueryKey),
      { wrapper: buildWrapper(queryClient) },
    );
