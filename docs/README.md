...
Текущий этап — разработка: спроектирована архитектура обоих процессов, реализованы экран входа, авторизация по токену, экран **Задачи** (списочное и kanban-отображение, drag-and-drop смены статуса), экран **Сегодня** (та же функциональность, отфильтрованная по `today | overdue`, с секциями «Просрочено»/«Сегодня» и массовым переносом просроченных) и управление **Проектами** (список в сайдбаре, создание, редактирование, архивация, удаление).
